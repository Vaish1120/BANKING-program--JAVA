...
class Banking
{
    ...
    private int Account_number = 110026852;
    ...
    void CreateAccount() 
    {
        ...
        if (choice == 1)
        {
            do
            {
                Customer_name = c.readLine((">>>>Enter your first name: "));
                for (int i = 0; i < Customer_name.length(); i++)
                {
                    ...
                    else
                    {
                        ...
                        System.out.println("Name can only have alphabets ");
                        retry = 1;
                        break;
                    }
                }
    ...
    void showMenu()
    {
        ...
        do
        {
            ...
            System.out.println("4. Show he Balance");
            System.out.println("5. Show the Account Information");
...
class BankingSystemApp
{
    public static void main(String[] args) throws Exception
    {
        System.out.println("**********************");
        System.out.println();
        System.out.println("WELCOME TO  JAVA TESTING BANK ");
        System.out.println();
        System.out.println("**********************");
        System.out.println();
